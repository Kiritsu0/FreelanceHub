...
const Jobcard = ({job}) => {
  ...
  return (
    <div
      className="flex flex-col gap-3 h-68 min-w-[20rem] max-w-[40rem] mx-4 p-2 rounded-md dark:bg-slate-900 bg-white dark:hover:bg-slate-700 hover:bg-gray-200 shadow-xl"
    >
      ...
      <div className="flex justify-between items-center">
        ...
        <a
          href={
            job.jobProviders && job.jobProviders[0]
