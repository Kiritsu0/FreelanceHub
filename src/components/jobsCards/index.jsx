...
const Jobcard = () => {
  ...
  const [heartColors, setHeartColors] = useState(Array(data.length).fill(""));

  const handleHeartColor = (index) => {
    const newHeartColors = [...heartColors];
    newHeartColors[index] = newHeartColors[index] === "" ? "#22c55e" : "";
      ...
      {data.map((job, index) => (
        ...
        >
          <div className="flex items-center justify-between gap-2">
            ...
            <FaHeart
              onClick={() => handleHeartColor(index)}
